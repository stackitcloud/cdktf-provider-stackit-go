...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/resources/redis_instance stackit_redis_instance}.
...
func (j *jsiiProxy_RedisInstance) CfGuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfGuid",
...
func (j *jsiiProxy_RedisInstance) CfOrganizationGuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfOrganizationGuid",
...
func (j *jsiiProxy_RedisInstance) CfSpaceGuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfSpaceGuid",
...
func (j *jsiiProxy_RedisInstance) DashboardUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dashboardUrl",
...
func (j *jsiiProxy_RedisInstance) ImageUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageUrl",
...
func (j *jsiiProxy_RedisInstance) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_RedisInstance) Parameters() RedisInstanceParametersOutputReference {
	var returns RedisInstanceParametersOutputReference
	_jsii_.Get(
		j,
		"parameters",
		&returns,
...
func (j *jsiiProxy_RedisInstance) ParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parametersInput",
...
func (j *jsiiProxy_RedisInstance) PlanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planId",
...
func (j *jsiiProxy_RedisInstance) PlanName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planName",
...
func (j *jsiiProxy_RedisInstance) PlanNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planNameInput",
...
func (j *jsiiProxy_RedisInstance) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_RedisInstance) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_RedisInstance) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
func (j *jsiiProxy_RedisInstance) VersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionInput",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/resources/redis_instance stackit_redis_instance} Resource.
...
func (j *jsiiProxy_RedisInstance)SetPlanName(val *string) {
...
func (j *jsiiProxy_RedisInstance)SetProjectId(val *string) {
...
func (j *jsiiProxy_RedisInstance)SetVersion(val *string) {
...
func (r *jsiiProxy_RedisInstance) PutParameters(value *RedisInstanceParameters) {
...
func (r *jsiiProxy_RedisInstance) ResetParameters() {
	_jsii_.InvokeVoid(
		r,
		"resetParameters",
		nil, // no parameters
