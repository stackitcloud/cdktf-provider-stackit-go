...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ObservabilityAlertgroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.observabilityAlertgroup.ObservabilityAlertgroupConfig",
		reflect.TypeOf((*ObservabilityAlertgroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.observabilityAlertgroup.ObservabilityAlertgroupRules",
		reflect.TypeOf((*ObservabilityAlertgroupRules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.observabilityAlertgroup.ObservabilityAlertgroupRulesList",
		reflect.TypeOf((*ObservabilityAlertgroupRulesList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ObservabilityAlertgroupRulesList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ObservabilityAlertgroupRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
