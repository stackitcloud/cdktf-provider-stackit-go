...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitResourcemanagerFolder)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitResourcemanagerFolder.DataStackitResourcemanagerFolderConfig",
		reflect.TypeOf((*DataStackitResourcemanagerFolderConfig)(nil)).Elem(),
	)
}
