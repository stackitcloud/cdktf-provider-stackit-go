...
type DataStackitResourcemanagerFolderConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.110.0/docs/data-sources/resourcemanager_folder#container_id DataStackitResourcemanagerFolder#container_id}
