...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv4VpcNetworkRangeId", GoGetter: "Ipv4VpcNetworkRangeId"},
			_jsii_.MemberProperty{JsiiProperty: "ipv4VpcNetworkRangeIdInput", GoGetter: "Ipv4VpcNetworkRangeIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv6VpcNetworkRangeId", GoGetter: "Ipv6VpcNetworkRangeId"},
			_jsii_.MemberProperty{JsiiProperty: "ipv6VpcNetworkRangeIdInput", GoGetter: "Ipv6VpcNetworkRangeIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpv4VpcNetworkRangeId", GoMethod: "ResetIpv4VpcNetworkRangeId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpv6VpcNetworkRangeId", GoMethod: "ResetIpv6VpcNetworkRangeId"},
