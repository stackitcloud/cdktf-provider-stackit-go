...
type ApplicationLoadBalancerListenersHttpHostsRulesCookiePersistence struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.88.0/docs/resources/application_load_balancer#ttl ApplicationLoadBalancer#ttl}
