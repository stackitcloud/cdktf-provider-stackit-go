...
func (a *jsiiProxy_ApplicationLoadBalancer) validatePutListenersParameters(value interface{}) error {
	...
	case *[]*ApplicationLoadBalancerListeners:
		value := value.(*[]*ApplicationLoadBalancerListeners)
	...
	case []*ApplicationLoadBalancerListeners:
		value_ := value.([]*ApplicationLoadBalancerListeners)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApplicationLoadBalancerListeners; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_ApplicationLoadBalancer) validatePutNetworksParameters(value interface{}) error {
	...
	case *[]*ApplicationLoadBalancerNetworks:
		value := value.(*[]*ApplicationLoadBalancerNetworks)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ApplicationLoadBalancerNetworks:
		value_ := value.([]*ApplicationLoadBalancerNetworks)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApplicationLoadBalancerNetworks; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_ApplicationLoadBalancer) validatePutTargetPoolsParameters(value interface{}) error {
	...
	case *[]*ApplicationLoadBalancerTargetPools:
		value := value.(*[]*ApplicationLoadBalancerTargetPools)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ApplicationLoadBalancerTargetPools:
		value_ := value.([]*ApplicationLoadBalancerTargetPools)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApplicationLoadBalancerTargetPools; received %#v (a %T)", value, value)
		}
	}
