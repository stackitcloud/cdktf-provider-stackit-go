...
type ApplicationLoadBalancerListenersHttps struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.105.0/docs/resources/application_load_balancer#certificate_config ApplicationLoadBalancer#certificate_config}
