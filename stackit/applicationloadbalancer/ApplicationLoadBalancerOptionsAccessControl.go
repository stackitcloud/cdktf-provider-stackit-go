...
type ApplicationLoadBalancerOptionsAccessControl struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.88.0/docs/resources/application_load_balancer#allowed_source_ranges ApplicationLoadBalancer#allowed_source_ranges}
