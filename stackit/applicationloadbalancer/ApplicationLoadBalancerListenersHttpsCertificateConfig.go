...
type ApplicationLoadBalancerListenersHttpsCertificateConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.106.0/docs/resources/application_load_balancer#certificate_ids ApplicationLoadBalancer#certificate_ids}
