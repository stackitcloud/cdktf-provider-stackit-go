...
type ApplicationLoadBalancerTargetPoolsActiveHealthCheckHttpHealthChecks struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.87.0/docs/resources/application_load_balancer#ok_status ApplicationLoadBalancer#ok_status}
