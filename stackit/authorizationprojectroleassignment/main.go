...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuthorizationProjectRoleAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.authorizationProjectRoleAssignment.AuthorizationProjectRoleAssignmentConfig",
		reflect.TypeOf((*AuthorizationProjectRoleAssignmentConfig)(nil)).Elem(),
	)
}
