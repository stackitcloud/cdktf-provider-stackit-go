...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresqlInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.postgresqlInstance.PostgresqlInstanceConfig",
		reflect.TypeOf((*PostgresqlInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.postgresqlInstance.PostgresqlInstanceParameters",
		reflect.TypeOf((*PostgresqlInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.postgresqlInstance.PostgresqlInstanceParametersOutputReference",
		reflect.TypeOf((*PostgresqlInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPlugins", GoMethod: "ResetPlugins"},
