...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MariadbInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.mariadbInstance.MariadbInstanceConfig",
		reflect.TypeOf((*MariadbInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.mariadbInstance.MariadbInstanceParameters",
		reflect.TypeOf((*MariadbInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.mariadbInstance.MariadbInstanceParametersOutputReference",
		reflect.TypeOf((*MariadbInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
