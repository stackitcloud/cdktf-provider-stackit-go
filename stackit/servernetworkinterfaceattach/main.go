...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServerNetworkInterfaceAttach)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.serverNetworkInterfaceAttach.ServerNetworkInterfaceAttachConfig",
		reflect.TypeOf((*ServerNetworkInterfaceAttachConfig)(nil)).Elem(),
	)
}
