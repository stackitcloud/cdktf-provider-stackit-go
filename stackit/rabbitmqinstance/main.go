...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RabbitmqInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.rabbitmqInstance.RabbitmqInstanceConfig",
		reflect.TypeOf((*RabbitmqInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.rabbitmqInstance.RabbitmqInstanceParameters",
		reflect.TypeOf((*RabbitmqInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.rabbitmqInstance.RabbitmqInstanceParametersOutputReference",
		reflect.TypeOf((*RabbitmqInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
