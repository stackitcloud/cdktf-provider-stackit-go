...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitDremioUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitDremioUser.DataStackitDremioUserConfig",
		reflect.TypeOf((*DataStackitDremioUserConfig)(nil)).Elem(),
	)
}
