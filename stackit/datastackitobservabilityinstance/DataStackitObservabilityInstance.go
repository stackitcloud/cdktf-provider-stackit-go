...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/data-sources/observability_instance stackit_observability_instance}.
...
func (j *jsiiProxy_DataStackitObservabilityInstance) GrafanaAdminEnabled() cdktf.IResolvable {
...
func (j *jsiiProxy_DataStackitObservabilityInstance) OtlpGrpcTracesUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpGrpcTracesUrl",
...
func (j *jsiiProxy_DataStackitObservabilityInstance) OtlpHttpLogsUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpHttpLogsUrl",
...
func (j *jsiiProxy_DataStackitObservabilityInstance) OtlpHttpTracesUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpHttpTracesUrl",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/data-sources/observability_instance stackit_observability_instance} Data Source.
