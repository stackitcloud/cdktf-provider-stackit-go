...
type PostgresflexInstanceNetwork struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.115.0/docs/resources/postgresflex_instance#access_scope PostgresflexInstance#access_scope}
