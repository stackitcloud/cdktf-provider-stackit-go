...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresflexInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.postgresflexInstance.PostgresflexInstanceConfig",
		reflect.TypeOf((*PostgresflexInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.postgresflexInstance.PostgresflexInstanceFlavor",
		reflect.TypeOf((*PostgresflexInstanceFlavor)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.postgresflexInstance.PostgresflexInstanceFlavorOutputReference",
		reflect.TypeOf((*PostgresflexInstanceFlavorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.postgresflexInstance.PostgresflexInstanceStorage",
		reflect.TypeOf((*PostgresflexInstanceStorage)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.postgresflexInstance.PostgresflexInstanceStorageOutputReference",
		reflect.TypeOf((*PostgresflexInstanceStorageOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_PostgresflexInstanceStorageOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
