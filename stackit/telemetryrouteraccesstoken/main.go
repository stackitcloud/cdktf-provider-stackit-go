...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TelemetryrouterAccessToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.telemetryrouterAccessToken.TelemetryrouterAccessTokenConfig",
		reflect.TypeOf((*TelemetryrouterAccessTokenConfig)(nil)).Elem(),
	)
}
