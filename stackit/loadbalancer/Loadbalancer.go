...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/loadbalancer stackit_loadbalancer}.
...
func (j *jsiiProxy_Loadbalancer) ExternalAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"externalAddress",
...
func (j *jsiiProxy_Loadbalancer) ExternalAddressInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Loadbalancer) Listeners() LoadbalancerListenersList {
	var returns LoadbalancerListenersList
	_jsii_.Get(
		j,
		"listeners",
		&returns,
...
func (j *jsiiProxy_Loadbalancer) ListenersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"listenersInput",
...
func (j *jsiiProxy_Loadbalancer) Options() LoadbalancerOptionsOutputReference {
	var returns LoadbalancerOptionsOutputReference
	_jsii_.Get(
		j,
		"options",
		&returns,
...
func (j *jsiiProxy_Loadbalancer) OptionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionsInput",
...
func (j *jsiiProxy_Loadbalancer) TargetPoolsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetPoolsInput",
...
func (j *jsiiProxy_Loadbalancer) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/loadbalancer stackit_loadbalancer} Resource.
...
func (j *jsiiProxy_Loadbalancer)SetExternalAddress(val *string) {
...
func (l *jsiiProxy_Loadbalancer) PutListeners(value interface{}) {
	if err := l.validatePutListenersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_Loadbalancer) PutOptions(value *LoadbalancerOptions) {
	if err := l.validatePutOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_Loadbalancer) PutTargetPools(value interface{}) {
	if err := l.validatePutTargetPoolsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_Loadbalancer) ResetOptions() {
	_jsii_.InvokeVoid(
		l,
		"resetOptions",
		nil, // no parameters
