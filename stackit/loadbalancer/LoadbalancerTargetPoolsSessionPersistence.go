...
type LoadbalancerTargetPoolsSessionPersistence struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.44.0/docs/resources/loadbalancer#use_source_ip_address Loadbalancer#use_source_ip_address}
