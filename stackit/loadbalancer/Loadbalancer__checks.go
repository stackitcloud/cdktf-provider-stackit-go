...
func (l *jsiiProxy_Loadbalancer) validatePutListenersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*LoadbalancerListeners:
		value := value.(*[]*LoadbalancerListeners)
	...
	case []*LoadbalancerListeners:
		value_ := value.([]*LoadbalancerListeners)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LoadbalancerListeners; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_Loadbalancer) validatePutOptionsParameters(value *LoadbalancerOptions) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (l *jsiiProxy_Loadbalancer) validatePutTargetPoolsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*LoadbalancerTargetPools:
		value := value.(*[]*LoadbalancerTargetPools)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*LoadbalancerTargetPools:
		value_ := value.([]*LoadbalancerTargetPools)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LoadbalancerTargetPools; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Loadbalancer) validateSetDisableSecurityGroupAssignmentParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_Loadbalancer) validateSetExternalAddressParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
