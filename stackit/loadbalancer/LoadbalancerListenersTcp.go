...
type LoadbalancerListenersTcp struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.80.0/docs/resources/loadbalancer#idle_timeout Loadbalancer#idle_timeout}
