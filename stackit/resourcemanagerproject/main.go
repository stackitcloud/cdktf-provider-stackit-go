...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ResourcemanagerProject)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.resourcemanagerProject.ResourcemanagerProjectConfig",
		reflect.TypeOf((*ResourcemanagerProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.resourcemanagerProject.ResourcemanagerProjectMembers",
		reflect.TypeOf((*ResourcemanagerProjectMembers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.resourcemanagerProject.ResourcemanagerProjectMembersList",
		reflect.TypeOf((*ResourcemanagerProjectMembersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ResourcemanagerProjectMembersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
