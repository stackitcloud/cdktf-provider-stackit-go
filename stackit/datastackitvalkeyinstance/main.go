...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitValkeyInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitValkeyInstance.DataStackitValkeyInstanceConfig",
		reflect.TypeOf((*DataStackitValkeyInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitValkeyInstance.DataStackitValkeyInstanceParameters",
		reflect.TypeOf((*DataStackitValkeyInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitValkeyInstance.DataStackitValkeyInstanceParametersOutputReference",
		reflect.TypeOf((*DataStackitValkeyInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "minReplicasToWrite", GoGetter: "MinReplicasToWrite"},
			...
			_jsii_.MemberProperty{JsiiProperty: "replBacklogSize", GoGetter: "ReplBacklogSize"},
