...
import (
	...
	"github.com/stackitcloud/cdktf-provider-stackit-go/stackit/vpc/internal"
	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/vpc stackit_vpc}.
type Vpc interface {
...
func (j *jsiiProxy_Vpc) Labels() *map[string]*string {
...
func (j *jsiiProxy_Vpc) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_Vpc) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_Vpc) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/vpc stackit_vpc} Resource.
...
func (j *jsiiProxy_Vpc)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_Vpc)SetProjectId(val *string) {
...
func (v *jsiiProxy_Vpc) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
