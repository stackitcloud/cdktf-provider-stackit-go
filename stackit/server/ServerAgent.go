...
type ServerAgent struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.101.0/docs/resources/server#provisioning_policy Server#provisioning_policy}
