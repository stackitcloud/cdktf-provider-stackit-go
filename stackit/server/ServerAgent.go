...
type ServerAgent struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.107.0/docs/resources/server#provisioning_policy Server#provisioning_policy}
