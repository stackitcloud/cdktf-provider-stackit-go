...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuthorizationFolderCustomRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.authorizationFolderCustomRole.AuthorizationFolderCustomRoleConfig",
		reflect.TypeOf((*AuthorizationFolderCustomRoleConfig)(nil)).Elem(),
	)
}
