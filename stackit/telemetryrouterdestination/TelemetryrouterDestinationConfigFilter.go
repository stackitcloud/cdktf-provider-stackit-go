...
type TelemetryrouterDestinationConfigFilter struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.110.0/docs/resources/telemetryrouter_destination#attributes TelemetryrouterDestination#attributes}
