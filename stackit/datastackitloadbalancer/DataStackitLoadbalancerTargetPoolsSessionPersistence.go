...
type DataStackitLoadbalancerTargetPoolsSessionPersistence struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.18.0/docs/data-sources/loadbalancer#use_source_ip_address DataStackitLoadbalancer#use_source_ip_address}
