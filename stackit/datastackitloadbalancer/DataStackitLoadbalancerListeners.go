...
type DataStackitLoadbalancerListeners struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.43.0/docs/data-sources/loadbalancer#server_name_indicators DataStackitLoadbalancer#server_name_indicators}
