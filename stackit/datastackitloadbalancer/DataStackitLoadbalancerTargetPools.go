...
type DataStackitLoadbalancerTargetPools struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.61.0/docs/data-sources/loadbalancer#session_persistence DataStackitLoadbalancer#session_persistence}
