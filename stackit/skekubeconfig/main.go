...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SkeKubeconfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "refreshBefore", GoGetter: "RefreshBefore"},
			_jsii_.MemberProperty{JsiiProperty: "refreshBeforeInput", GoGetter: "RefreshBeforeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshBefore", GoMethod: "ResetRefreshBefore"},
	...
	_jsii_.RegisterStruct(
		"stackit.skeKubeconfig.SkeKubeconfigConfig",
		reflect.TypeOf((*SkeKubeconfigConfig)(nil)).Elem(),
	)
}
