...
func init() {
	_jsii_.RegisterClass(
		"stackit.dataStackitRedisCredentials.DataStackitRedisCredentials",
		reflect.TypeOf((*DataStackitRedisCredentials)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataStackitRedisCredentials{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitRedisCredentials.DataStackitRedisCredentialsConfig",
		reflect.TypeOf((*DataStackitRedisCredentialsConfig)(nil)).Elem(),
	)
}
