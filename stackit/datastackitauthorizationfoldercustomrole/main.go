...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitAuthorizationFolderCustomRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitAuthorizationFolderCustomRole.DataStackitAuthorizationFolderCustomRoleConfig",
		reflect.TypeOf((*DataStackitAuthorizationFolderCustomRoleConfig)(nil)).Elem(),
	)
}
