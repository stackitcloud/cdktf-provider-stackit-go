...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitNetworkInterface)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitNetworkInterface.DataStackitNetworkInterfaceConfig",
		reflect.TypeOf((*DataStackitNetworkInterfaceConfig)(nil)).Elem(),
	)
}
