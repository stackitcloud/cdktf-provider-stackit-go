...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsmanagerInstanceRoleBindingV1)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.secretsmanagerInstanceRoleBindingV1.SecretsmanagerInstanceRoleBindingV1Config",
		reflect.TypeOf((*SecretsmanagerInstanceRoleBindingV1Config)(nil)).Elem(),
	)
}
