...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitValkeyCredential)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "loadBalancedHost", GoGetter: "LoadBalancedHost"},
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitValkeyCredential.DataStackitValkeyCredentialConfig",
		reflect.TypeOf((*DataStackitValkeyCredentialConfig)(nil)).Elem(),
	)
}
