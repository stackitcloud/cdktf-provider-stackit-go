...
func init() {
	_jsii_.RegisterClass(
		"stackit.postgresqlCredentials.PostgresqlCredentials",
		reflect.TypeOf((*PostgresqlCredentials)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_PostgresqlCredentials{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"stackit.postgresqlCredentials.PostgresqlCredentialsConfig",
		reflect.TypeOf((*PostgresqlCredentialsConfig)(nil)).Elem(),
	)
}
