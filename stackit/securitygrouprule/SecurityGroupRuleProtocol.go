...
type SecurityGroupRuleProtocol struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.97.0/docs/resources/security_group_rule#name SecurityGroupRule#name}
	Name *string `field:"optional" json:"name" yaml:"name"`
	// The protocol number which the rule should match. Either `name` or `number` must be provided.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.97.0/docs/resources/security_group_rule#number SecurityGroupRule#number}
