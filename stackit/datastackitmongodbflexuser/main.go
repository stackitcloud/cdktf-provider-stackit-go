...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitMongodbflexUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitMongodbflexUser.DataStackitMongodbflexUserConfig",
		reflect.TypeOf((*DataStackitMongodbflexUserConfig)(nil)).Elem(),
	)
}
