...
type DataStackitSqlserverflexInstanceNetwork struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.115.0/docs/data-sources/sqlserverflex_instance#access_scope DataStackitSqlserverflexInstance#access_scope}
