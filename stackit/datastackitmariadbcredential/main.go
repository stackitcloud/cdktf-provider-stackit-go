...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitMariadbCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitMariadbCredential.DataStackitMariadbCredentialConfig",
		reflect.TypeOf((*DataStackitMariadbCredentialConfig)(nil)).Elem(),
	)
}
