...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EdgecloudKubeconfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kubeconfigId", GoGetter: "KubeconfigId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "recreateBefore", GoGetter: "RecreateBefore"},
			_jsii_.MemberProperty{JsiiProperty: "recreateBeforeInput", GoGetter: "RecreateBeforeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRecreateBefore", GoMethod: "ResetRecreateBefore"},
	...
	_jsii_.RegisterStruct(
		"stackit.edgecloudKubeconfig.EdgecloudKubeconfigConfig",
		reflect.TypeOf((*EdgecloudKubeconfigConfig)(nil)).Elem(),
	)
}
