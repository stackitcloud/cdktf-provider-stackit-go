...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitLogsAccessToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitLogsAccessToken.DataStackitLogsAccessTokenConfig",
		reflect.TypeOf((*DataStackitLogsAccessTokenConfig)(nil)).Elem(),
	)
}
