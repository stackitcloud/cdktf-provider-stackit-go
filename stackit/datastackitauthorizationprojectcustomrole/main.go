...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitAuthorizationProjectCustomRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitAuthorizationProjectCustomRole.DataStackitAuthorizationProjectCustomRoleConfig",
		reflect.TypeOf((*DataStackitAuthorizationProjectCustomRoleConfig)(nil)).Elem(),
	)
}
