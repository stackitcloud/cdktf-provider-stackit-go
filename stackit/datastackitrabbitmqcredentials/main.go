...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitRabbitmqCredentials)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitRabbitmqCredentials.DataStackitRabbitmqCredentialsConfig",
		reflect.TypeOf((*DataStackitRabbitmqCredentialsConfig)(nil)).Elem(),
	)
}
