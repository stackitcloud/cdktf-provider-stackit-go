...
import (
	...
	"github.com/stackitcloud/cdktf-provider-stackit-go/stackit/serviceaccountkey/internal"
	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.104.0/docs/resources/service_account_key stackit_service_account_key}.
...
func (j *jsiiProxy_ServiceAccountKey) Json() *string {
	var returns *string
	_jsii_.Get(
		j,
		"json",
...
func (j *jsiiProxy_ServiceAccountKey) KeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_ServiceAccountKey) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_ServiceAccountKey) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_ServiceAccountKey) PublicKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyInput",
...
func (j *jsiiProxy_ServiceAccountKey) RotateWhenChanged() *map[string]*string {
...
func (j *jsiiProxy_ServiceAccountKey) RotateWhenChangedInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServiceAccountKey) ServiceAccountEmail() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountEmail",
...
func (j *jsiiProxy_ServiceAccountKey) ServiceAccountEmailInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServiceAccountKey) TtlDays() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"ttlDays",
...
func (j *jsiiProxy_ServiceAccountKey) TtlDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"ttlDaysInput",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.104.0/docs/resources/service_account_key stackit_service_account_key} Resource.
func NewServiceAccountKey(scope constructs.Construct, id *string, config *ServiceAccountKeyConfig) ServiceAccountKey {
	...
	_jsii_.Create(
		"stackit.serviceAccountKey.ServiceAccountKey",
...
func (j *jsiiProxy_ServiceAccountKey)SetProjectId(val *string) {
...
func (j *jsiiProxy_ServiceAccountKey)SetPublicKey(val *string) {
...
func (j *jsiiProxy_ServiceAccountKey)SetRotateWhenChanged(val *map[string]*string) {
...
func (j *jsiiProxy_ServiceAccountKey)SetServiceAccountEmail(val *string) {
...
func (j *jsiiProxy_ServiceAccountKey)SetTtlDays(val *float64) {
...
func (s *jsiiProxy_ServiceAccountKey) ResetPublicKey() {
	_jsii_.InvokeVoid(
		s,
		"resetPublicKey",
		nil, // no parameters
...
func (s *jsiiProxy_ServiceAccountKey) ResetRotateWhenChanged() {
	_jsii_.InvokeVoid(
		s,
		"resetRotateWhenChanged",
		nil, // no parameters
...
func (s *jsiiProxy_ServiceAccountKey) ResetTtlDays() {
	_jsii_.InvokeVoid(
		s,
		"resetTtlDays",
		nil, // no parameters
