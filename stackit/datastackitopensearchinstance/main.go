...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitOpensearchInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitOpensearchInstance.DataStackitOpensearchInstanceConfig",
		reflect.TypeOf((*DataStackitOpensearchInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitOpensearchInstance.DataStackitOpensearchInstanceParameters",
		reflect.TypeOf((*DataStackitOpensearchInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitOpensearchInstance.DataStackitOpensearchInstanceParametersOutputReference",
		reflect.TypeOf((*DataStackitOpensearchInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "javaGarbageCollector", GoGetter: "JavaGarbageCollector"},
