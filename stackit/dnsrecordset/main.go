...
func init() {
	...
	_jsii_.RegisterStruct(
		"stackit.dnsRecordSet.DnsRecordSetConfig",
		reflect.TypeOf((*DnsRecordSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dnsRecordSet.DnsRecordSetTimeouts",
		reflect.TypeOf((*DnsRecordSetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dnsRecordSet.DnsRecordSetTimeoutsOutputReference",
		reflect.TypeOf((*DnsRecordSetTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
