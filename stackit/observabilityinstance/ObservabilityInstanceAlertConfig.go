...
type ObservabilityInstanceAlertConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.68.0/docs/resources/observability_instance#receivers ObservabilityInstance#receivers}
	Receivers interface{} `field:"required" json:"receivers" yaml:"receivers"`
	// Route configuration for the alerts.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.68.0/docs/resources/observability_instance#route ObservabilityInstance#route}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.68.0/docs/resources/observability_instance#global ObservabilityInstance#global}
