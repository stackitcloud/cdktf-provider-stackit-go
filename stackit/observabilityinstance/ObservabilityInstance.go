...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.101.0/docs/resources/observability_instance stackit_observability_instance}.
...
func (j *jsiiProxy_ObservabilityInstance) OtlpGrpcTracesUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpGrpcTracesUrl",
...
func (j *jsiiProxy_ObservabilityInstance) OtlpHttpLogsUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpHttpLogsUrl",
...
func (j *jsiiProxy_ObservabilityInstance) OtlpHttpTracesUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"otlpHttpTracesUrl",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.101.0/docs/resources/observability_instance stackit_observability_instance} Resource.
