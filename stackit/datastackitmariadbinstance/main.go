...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitMariadbInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitMariadbInstance.DataStackitMariadbInstanceConfig",
		reflect.TypeOf((*DataStackitMariadbInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitMariadbInstance.DataStackitMariadbInstanceParameters",
		reflect.TypeOf((*DataStackitMariadbInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitMariadbInstance.DataStackitMariadbInstanceParametersOutputReference",
		reflect.TypeOf((*DataStackitMariadbInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
