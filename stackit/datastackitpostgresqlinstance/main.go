...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitPostgresqlInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitPostgresqlInstance.DataStackitPostgresqlInstanceConfig",
		reflect.TypeOf((*DataStackitPostgresqlInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitPostgresqlInstance.DataStackitPostgresqlInstanceParameters",
		reflect.TypeOf((*DataStackitPostgresqlInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitPostgresqlInstance.DataStackitPostgresqlInstanceParametersOutputReference",
		reflect.TypeOf((*DataStackitPostgresqlInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataStackitPostgresqlInstanceParametersOutputReference{}
