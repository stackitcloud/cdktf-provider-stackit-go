...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitKmsWrappingKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "wrappingKeyId", GoGetter: "WrappingKeyId"},
			_jsii_.MemberProperty{JsiiProperty: "wrappingKeyIdInput", GoGetter: "WrappingKeyIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitKmsWrappingKey.DataStackitKmsWrappingKeyConfig",
		reflect.TypeOf((*DataStackitKmsWrappingKeyConfig)(nil)).Elem(),
	)
}
