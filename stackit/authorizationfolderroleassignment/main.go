...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuthorizationFolderRoleAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.authorizationFolderRoleAssignment.AuthorizationFolderRoleAssignmentConfig",
		reflect.TypeOf((*AuthorizationFolderRoleAssignmentConfig)(nil)).Elem(),
	)
}
