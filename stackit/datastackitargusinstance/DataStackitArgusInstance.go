...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.26.0/docs/data-sources/argus_instance stackit_argus_instance}.
type DataStackitArgusInstance interface {
	cdktf.TerraformDataSource
	Acl() *[]*string
	AlertConfig() DataStackitArgusInstanceAlertConfigOutputReference
	AlertingUrl() *string
	// Experimental.
...
func (j *jsiiProxy_DataStackitArgusInstance) AlertConfig() DataStackitArgusInstanceAlertConfigOutputReference {
	var returns DataStackitArgusInstanceAlertConfigOutputReference
	_jsii_.Get(
		j,
		"alertConfig",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.26.0/docs/data-sources/argus_instance stackit_argus_instance} Data Source.
