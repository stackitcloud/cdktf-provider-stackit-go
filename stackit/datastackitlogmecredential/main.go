...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitLogmeCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitLogmeCredential.DataStackitLogmeCredentialConfig",
		reflect.TypeOf((*DataStackitLogmeCredentialConfig)(nil)).Elem(),
	)
}
