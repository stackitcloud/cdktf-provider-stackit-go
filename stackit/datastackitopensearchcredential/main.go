...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitOpensearchCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitOpensearchCredential.DataStackitOpensearchCredentialConfig",
		reflect.TypeOf((*DataStackitOpensearchCredentialConfig)(nil)).Elem(),
	)
}
