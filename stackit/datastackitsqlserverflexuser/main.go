...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitSqlserverflexUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitSqlserverflexUser.DataStackitSqlserverflexUserConfig",
		reflect.TypeOf((*DataStackitSqlserverflexUserConfig)(nil)).Elem(),
	)
}
