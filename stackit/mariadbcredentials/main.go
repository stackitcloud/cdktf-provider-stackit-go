...
func init() {
	_jsii_.RegisterClass(
		"stackit.mariadbCredentials.MariadbCredentials",
		reflect.TypeOf((*MariadbCredentials)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_MariadbCredentials{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"stackit.mariadbCredentials.MariadbCredentialsConfig",
		reflect.TypeOf((*MariadbCredentialsConfig)(nil)).Elem(),
	)
}
