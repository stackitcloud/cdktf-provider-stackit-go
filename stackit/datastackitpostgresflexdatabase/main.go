...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitPostgresflexDatabase)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitPostgresflexDatabase.DataStackitPostgresflexDatabaseConfig",
		reflect.TypeOf((*DataStackitPostgresflexDatabaseConfig)(nil)).Elem(),
	)
}
