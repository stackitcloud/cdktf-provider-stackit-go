...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitPostgresqlCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitPostgresqlCredential.DataStackitPostgresqlCredentialConfig",
		reflect.TypeOf((*DataStackitPostgresqlCredentialConfig)(nil)).Elem(),
	)
}
