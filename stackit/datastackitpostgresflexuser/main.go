...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitPostgresflexUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitPostgresflexUser.DataStackitPostgresflexUserConfig",
		reflect.TypeOf((*DataStackitPostgresflexUserConfig)(nil)).Elem(),
	)
}
