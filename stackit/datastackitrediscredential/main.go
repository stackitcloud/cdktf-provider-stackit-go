...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitRedisCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitRedisCredential.DataStackitRedisCredentialConfig",
		reflect.TypeOf((*DataStackitRedisCredentialConfig)(nil)).Elem(),
	)
}
