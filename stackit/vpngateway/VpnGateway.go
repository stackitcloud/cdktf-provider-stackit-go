...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.104.0/docs/resources/vpn_gateway stackit_vpn_gateway}.
type VpnGateway interface {
	...
	Bgp() VpnGatewayBgpOutputReference
	BgpInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_VpnGateway) AvailabilityZones() VpnGatewayAvailabilityZonesOutputReference {
	var returns VpnGatewayAvailabilityZonesOutputReference
	_jsii_.Get(
		j,
		"availabilityZones",
		&returns,
...
func (j *jsiiProxy_VpnGateway) AvailabilityZonesInput() interface{} {
...
func (j *jsiiProxy_VpnGateway) Bgp() VpnGatewayBgpOutputReference {
	var returns VpnGatewayBgpOutputReference
	_jsii_.Get(
		j,
		"bgp",
		&returns,
...
func (j *jsiiProxy_VpnGateway) BgpInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"bgpInput",
...
func (j *jsiiProxy_VpnGateway) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_VpnGateway) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_VpnGateway) Labels() *map[string]*string {
...
func (j *jsiiProxy_VpnGateway) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_VpnGateway) PlanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planId",
...
func (j *jsiiProxy_VpnGateway) PlanIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planIdInput",
...
func (j *jsiiProxy_VpnGateway) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_VpnGateway) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_VpnGateway) RoutingType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingType",
...
func (j *jsiiProxy_VpnGateway) RoutingTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingTypeInput",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.104.0/docs/resources/vpn_gateway stackit_vpn_gateway} Resource.
...
func (j *jsiiProxy_VpnGateway)SetDisplayName(val *string) {
...
func (j *jsiiProxy_VpnGateway)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_VpnGateway)SetPlanId(val *string) {
...
func (j *jsiiProxy_VpnGateway)SetProjectId(val *string) {
...
func (j *jsiiProxy_VpnGateway)SetRoutingType(val *string) {
...
func (v *jsiiProxy_VpnGateway) PutAvailabilityZones(value *VpnGatewayAvailabilityZones) {
	if err := v.validatePutAvailabilityZonesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VpnGateway) PutBgp(value *VpnGatewayBgp) {
...
func (v *jsiiProxy_VpnGateway) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
