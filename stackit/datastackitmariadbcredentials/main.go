...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitMariadbCredentials)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitMariadbCredentials.DataStackitMariadbCredentialsConfig",
		reflect.TypeOf((*DataStackitMariadbCredentialsConfig)(nil)).Elem(),
	)
}
