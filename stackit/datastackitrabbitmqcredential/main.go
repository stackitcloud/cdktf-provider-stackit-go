...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitRabbitmqCredential)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "httpApiUri", GoGetter: "HttpApiUri"},
			_jsii_.MemberProperty{JsiiProperty: "httpApiUris", GoGetter: "HttpApiUris"},
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitRabbitmqCredential.DataStackitRabbitmqCredentialConfig",
		reflect.TypeOf((*DataStackitRabbitmqCredentialConfig)(nil)).Elem(),
	)
}
