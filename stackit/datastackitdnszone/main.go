...
func init() {
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitDnsZone.DataStackitDnsZoneTimeouts",
		reflect.TypeOf((*DataStackitDnsZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitDnsZone.DataStackitDnsZoneTimeoutsOutputReference",
		reflect.TypeOf((*DataStackitDnsZoneTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
