...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.107.0/docs/data-sources/alb_waf_managed_rule_set stackit_alb_waf_managed_rule_set}.
type DataStackitAlbWafManagedRuleSet interface {
	...
	Type() *string
	Usage() DataStackitAlbWafManagedRuleSetUsageOutputReference
	Version() *string
	// Experimental.
...
func (j *jsiiProxy_DataStackitAlbWafManagedRuleSet) Usage() DataStackitAlbWafManagedRuleSetUsageOutputReference {
	var returns DataStackitAlbWafManagedRuleSetUsageOutputReference
	_jsii_.Get(
		j,
		"usage",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.107.0/docs/data-sources/alb_waf_managed_rule_set stackit_alb_waf_managed_rule_set} Data Source.
