...
type SkeClusterNetworkControlPlane struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.102.0/docs/resources/ske_cluster#access_scope SkeCluster#access_scope}
