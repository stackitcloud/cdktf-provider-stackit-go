...
type SkeClusterExtensionsArgus struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.60.0/docs/resources/ske_cluster#argus_instance_id SkeCluster#argus_instance_id}
