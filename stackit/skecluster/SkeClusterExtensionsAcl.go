...
type SkeClusterExtensionsAcl struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/ske_cluster#allowed_cidrs SkeCluster#allowed_cidrs}
