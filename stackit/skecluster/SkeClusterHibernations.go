...
type SkeClusterHibernations struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.13.0/docs/resources/ske_cluster#timezone SkeCluster#timezone}
