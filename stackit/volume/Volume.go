...
// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/volume stackit_volume}.
...
func (j *jsiiProxy_Volume) Labels() *map[string]*string {
...
func (j *jsiiProxy_Volume) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_Volume) PerformanceClass() *string {
	var returns *string
	_jsii_.Get(
		j,
		"performanceClass",
...
func (j *jsiiProxy_Volume) PerformanceClassInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Volume) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_Volume) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_Volume) Source() VolumeSourceOutputReference {
	var returns VolumeSourceOutputReference
	_jsii_.Get(
		j,
		"source",
		&returns,
...
func (j *jsiiProxy_Volume) SourceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceInput",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/volume stackit_volume} Resource.
...
func (j *jsiiProxy_Volume)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_Volume)SetPerformanceClass(val *string) {
...
func (j *jsiiProxy_Volume)SetProjectId(val *string) {
...
func (v *jsiiProxy_Volume) ResetPerformanceClass() {
	_jsii_.InvokeVoid(
		v,
		"resetPerformanceClass",
		nil, // no parameters
...
func (v *jsiiProxy_Volume) ResetSize() {
	_jsii_.InvokeVoid(
		v,
		"resetSize",
		nil, // no parameters
...
func (v *jsiiProxy_Volume) ResetSource() {
	_jsii_.InvokeVoid(
		v,
		"resetSource",
		nil, // no parameters
