...
func (j *jsiiProxy_Volume) validateSetLabelsParameters(val *map[string]*string) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetPerformanceClassParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetProjectIdParameters(val *string) error {
	return nil
}
