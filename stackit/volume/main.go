...
func init() {
	...
	_jsii_.RegisterStruct(
		"stackit.volume.VolumeConfig",
		reflect.TypeOf((*VolumeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.volume.VolumeSource",
		reflect.TypeOf((*VolumeSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.volume.VolumeSourceOutputReference",
		reflect.TypeOf((*VolumeSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_VolumeSourceOutputReference{}
