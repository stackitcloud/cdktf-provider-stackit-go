...
func init() {
	_jsii_.RegisterClass(
		"stackit.logmeCredentials.LogmeCredentials",
		reflect.TypeOf((*LogmeCredentials)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_LogmeCredentials{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"stackit.logmeCredentials.LogmeCredentialsConfig",
		reflect.TypeOf((*LogmeCredentialsConfig)(nil)).Elem(),
	)
}
