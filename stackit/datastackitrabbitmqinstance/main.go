...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitRabbitmqInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitRabbitmqInstance.DataStackitRabbitmqInstanceConfig",
		reflect.TypeOf((*DataStackitRabbitmqInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dataStackitRabbitmqInstance.DataStackitRabbitmqInstanceParameters",
		reflect.TypeOf((*DataStackitRabbitmqInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dataStackitRabbitmqInstance.DataStackitRabbitmqInstanceParametersOutputReference",
		reflect.TypeOf((*DataStackitRabbitmqInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "consumerTimeout", GoGetter: "ConsumerTimeout"},
