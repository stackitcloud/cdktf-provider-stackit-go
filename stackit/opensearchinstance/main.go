...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OpensearchInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.opensearchInstance.OpensearchInstanceConfig",
		reflect.TypeOf((*OpensearchInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.opensearchInstance.OpensearchInstanceParameters",
		reflect.TypeOf((*OpensearchInstanceParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.opensearchInstance.OpensearchInstanceParametersOutputReference",
		reflect.TypeOf((*OpensearchInstanceParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
