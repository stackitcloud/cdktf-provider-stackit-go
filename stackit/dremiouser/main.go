...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DremioUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dremioUser.DremioUserConfig",
		reflect.TypeOf((*DremioUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.dremioUser.DremioUserTimeouts",
		reflect.TypeOf((*DremioUserTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.dremioUser.DremioUserTimeoutsOutputReference",
		reflect.TypeOf((*DremioUserTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
