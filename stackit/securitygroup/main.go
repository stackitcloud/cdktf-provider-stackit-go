...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStateful", GoMethod: "ResetStateful"},
			...
			_jsii_.MemberProperty{JsiiProperty: "statefulInput", GoGetter: "StatefulInput"},
	...
	_jsii_.RegisterStruct(
		"stackit.securityGroup.SecurityGroupConfig",
