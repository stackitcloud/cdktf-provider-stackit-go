...
type CdnDistributionConfigA struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.60.0/docs/resources/cdn_distribution#backend CdnDistribution#backend}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.60.0/docs/resources/cdn_distribution#regions CdnDistribution#regions}
	Regions *[]*string `field:"required" json:"regions" yaml:"regions"`
	// The configured countries where distribution of content is blocked.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.60.0/docs/resources/cdn_distribution#blocked_countries CdnDistribution#blocked_countries}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.60.0/docs/resources/cdn_distribution#optimizer CdnDistribution#optimizer}
