...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServerServiceAccountAttach)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.serverServiceAccountAttach.ServerServiceAccountAttachConfig",
		reflect.TypeOf((*ServerServiceAccountAttachConfig)(nil)).Elem(),
	)
}
