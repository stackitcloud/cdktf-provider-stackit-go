...
import (
	...
	"github.com/stackitcloud/cdktf-provider-stackit-go/stackit/networkinterface/internal"
	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/resources/network_interface stackit_network_interface}.
...
func (j *jsiiProxy_NetworkInterface) AllowedAddresses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedAddresses",
...
func (j *jsiiProxy_NetworkInterface) AllowedAddressesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkInterface) Device() *string {
	var returns *string
	_jsii_.Get(
		j,
		"device",
...
func (j *jsiiProxy_NetworkInterface) Ipv4() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv4",
...
func (j *jsiiProxy_NetworkInterface) Ipv4Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv4Input",
...
func (j *jsiiProxy_NetworkInterface) Labels() *map[string]*string {
...
func (j *jsiiProxy_NetworkInterface) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_NetworkInterface) Mac() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mac",
...
func (j *jsiiProxy_NetworkInterface) NetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkId",
...
func (j *jsiiProxy_NetworkInterface) NetworkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkIdInput",
...
func (j *jsiiProxy_NetworkInterface) NetworkInterfaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInterfaceId",
...
func (j *jsiiProxy_NetworkInterface) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_NetworkInterface) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_NetworkInterface) Security() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"security",
...
func (j *jsiiProxy_NetworkInterface) SecurityGroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"securityGroupIds",
...
func (j *jsiiProxy_NetworkInterface) SecurityGroupIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkInterface) SecurityInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"securityInput",
...
func (j *jsiiProxy_NetworkInterface) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.100.0/docs/resources/network_interface stackit_network_interface} Resource.
func NewNetworkInterface(scope constructs.Construct, id *string, config *NetworkInterfaceConfig) NetworkInterface {
	...
	_jsii_.Create(
		"stackit.networkInterface.NetworkInterface",
...
func (j *jsiiProxy_NetworkInterface)SetAllowedAddresses(val *[]*string) {
...
func (j *jsiiProxy_NetworkInterface)SetIpv4(val *string) {
...
func (j *jsiiProxy_NetworkInterface)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_NetworkInterface)SetNetworkId(val *string) {
...
func (j *jsiiProxy_NetworkInterface)SetProjectId(val *string) {
...
func (j *jsiiProxy_NetworkInterface)SetSecurity(val interface{}) {
...
func (j *jsiiProxy_NetworkInterface)SetSecurityGroupIds(val *[]*string) {
...
func (n *jsiiProxy_NetworkInterface) ResetAllowedAddresses() {
	_jsii_.InvokeVoid(
		n,
		"resetAllowedAddresses",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkInterface) ResetIpv4() {
	_jsii_.InvokeVoid(
		n,
		"resetIpv4",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkInterface) ResetLabels() {
	_jsii_.InvokeVoid(
		n,
		"resetLabels",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkInterface) ResetName() {
	_jsii_.InvokeVoid(
		n,
		"resetName",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkInterface) ResetSecurity() {
	_jsii_.InvokeVoid(
		n,
		"resetSecurity",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkInterface) ResetSecurityGroupIds() {
	_jsii_.InvokeVoid(
		n,
		"resetSecurityGroupIds",
		nil, // no parameters
