...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataStackitLogmeCredentials)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.dataStackitLogmeCredentials.DataStackitLogmeCredentialsConfig",
		reflect.TypeOf((*DataStackitLogmeCredentialsConfig)(nil)).Elem(),
	)
}
