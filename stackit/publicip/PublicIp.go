...
import (
	...
	"github.com/stackitcloud/cdktf-provider-stackit-go/stackit/publicip/internal"
	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.101.0/docs/resources/public_ip stackit_public_ip}.
...
func (j *jsiiProxy_PublicIp) Ip() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ip",
...
func (j *jsiiProxy_PublicIp) Labels() *map[string]*string {
...
func (j *jsiiProxy_PublicIp) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_PublicIp) NetworkInterfaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInterfaceId",
...
func (j *jsiiProxy_PublicIp) NetworkInterfaceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PublicIp) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_PublicIp) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_PublicIp) PublicIpId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicIpId",
...
// Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.101.0/docs/resources/public_ip stackit_public_ip} Resource.
...
func (j *jsiiProxy_PublicIp)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_PublicIp)SetNetworkInterfaceId(val *string) {
...
func (j *jsiiProxy_PublicIp)SetProjectId(val *string) {
...
func (p *jsiiProxy_PublicIp) ResetLabels() {
	_jsii_.InvokeVoid(
		p,
		"resetLabels",
		nil, // no parameters
...
func (p *jsiiProxy_PublicIp) ResetNetworkInterfaceId() {
	_jsii_.InvokeVoid(
		p,
		"resetNetworkInterfaceId",
		nil, // no parameters
