...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ObjectstorageCredential)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.objectstorageCredential.ObjectstorageCredentialConfig",
		reflect.TypeOf((*ObjectstorageCredentialConfig)(nil)).Elem(),
	)
}
