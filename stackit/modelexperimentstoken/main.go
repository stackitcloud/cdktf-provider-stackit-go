...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ModelexperimentsToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.modelexperimentsToken.ModelexperimentsTokenConfig",
		reflect.TypeOf((*ModelexperimentsTokenConfig)(nil)).Elem(),
	)
}
