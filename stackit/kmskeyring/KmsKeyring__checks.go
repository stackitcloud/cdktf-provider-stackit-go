...
func (j *jsiiProxy_KmsKeyring) validateSetDescriptionParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_KmsKeyring) validateSetDisplayNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KmsKeyring) validateSetProjectIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KmsKeyring) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
