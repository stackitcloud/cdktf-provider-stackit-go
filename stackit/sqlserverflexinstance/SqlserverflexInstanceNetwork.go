...
type SqlserverflexInstanceNetwork struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.103.0/docs/resources/sqlserverflex_instance#access_scope SqlserverflexInstance#access_scope}
