...
type SqlserverflexInstanceStorage struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.114.0/docs/resources/sqlserverflex_instance#class SqlserverflexInstance#class}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.114.0/docs/resources/sqlserverflex_instance#size SqlserverflexInstance#size}
