...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuthorizationProjectCustomRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.authorizationProjectCustomRole.AuthorizationProjectCustomRoleConfig",
		reflect.TypeOf((*AuthorizationProjectCustomRoleConfig)(nil)).Elem(),
	)
}
