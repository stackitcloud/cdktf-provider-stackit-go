...
type TelemetryrouterInstanceFilter struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.99.0/docs/resources/telemetryrouter_instance#attributes TelemetryrouterInstance#attributes}
