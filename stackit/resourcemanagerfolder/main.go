...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ResourcemanagerFolder)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.resourcemanagerFolder.ResourcemanagerFolderConfig",
		reflect.TypeOf((*ResourcemanagerFolderConfig)(nil)).Elem(),
	)
}
