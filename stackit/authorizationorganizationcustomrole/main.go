...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuthorizationOrganizationCustomRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"stackit.authorizationOrganizationCustomRole.AuthorizationOrganizationCustomRoleConfig",
		reflect.TypeOf((*AuthorizationOrganizationCustomRoleConfig)(nil)).Elem(),
	)
}
