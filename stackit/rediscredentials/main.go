...
func init() {
	_jsii_.RegisterClass(
		"stackit.redisCredentials.RedisCredentials",
		reflect.TypeOf((*RedisCredentials)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_RedisCredentials{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"stackit.redisCredentials.RedisCredentialsConfig",
		reflect.TypeOf((*RedisCredentialsConfig)(nil)).Elem(),
	)
}
