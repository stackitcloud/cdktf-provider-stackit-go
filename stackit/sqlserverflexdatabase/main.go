...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlserverflexDatabase)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCompatibility", GoMethod: "ResetCompatibility"},
	...
	_jsii_.RegisterStruct(
		"stackit.sqlserverflexDatabase.SqlserverflexDatabaseConfig",
		reflect.TypeOf((*SqlserverflexDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"stackit.sqlserverflexDatabase.SqlserverflexDatabaseTimeouts",
		reflect.TypeOf((*SqlserverflexDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"stackit.sqlserverflexDatabase.SqlserverflexDatabaseTimeoutsOutputReference",
		reflect.TypeOf((*SqlserverflexDatabaseTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
